...
const timeframeOptions = ['1 hour', '2 hours', '4 hours', 'Today', 'Tomorrow'];
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Input id="title" name="title" placeholder="e.g., Pick up my IKEA order" value={formData.title} onChange={handleInputChange} required />
          </div>
          
          <div className="space-y-2">
            <Label htmlFor="description">Description</Label>
            <Textarea id="description" name="description" placeholder="Describe the items to be picked up and any special instructions" rows={3} value={formData.description} onChange={handleInputChange} required />
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="pickupLocation">Pickup Location</Label>
              <Input id="pickupLocation" name="pickupLocation" placeholder="Enter store or pickup address" value={formData.pickupLocation} onChange={handleInputChange} required />
            </div>
            
            <div className="space-y-2">
              <Label htmlFor="dropoffLocation">Dropoff Location</Label>
              <Input id="dropoffLocation" name="dropoffLocation" placeholder="Enter delivery address" value={formData.dropoffLocation} onChange={handleInputChange} required />
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="mt-2 flex flex-col items-center justify-center border-2 border-dashed rounded-md p-4 bg-linky-background">
                {previewUrl ? <div className="relative w-full">
                    <img src={previewUrl} alt="Product preview" className="h-32 mx-auto object-contain" />
        ...
        <CardFooter>
          <Button type="submit" disabled={isSubmitting} className="w-full bg-linky-primary hover:bg-linky-primary/90">
